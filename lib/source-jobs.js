...
// roll back if THIS click's reserve is still the latest write. If a later
// click already advanced the offset (shouldn't happen with the expectedOffset
// design, but defensive), the rollback is a no-op.
